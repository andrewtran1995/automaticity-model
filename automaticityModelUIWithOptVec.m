function [  ] = automaticityModelUIWithOptVec( arg_vector )
%AUTOMATICITYMODELUIWITHOPTVEC Translates particleSwarm results and calls
%automaticityModel (UI)
    ...
    % Call automaticityModel (UI)
    automaticityModel(params, optional_parms);
end
