...
%with automaticityModel
    ...
    mu_1                   = arg_vector(8);
    sigma_1                = arg_vector(9);
    mu_2                   = arg_vector(10);
    sigma_2                = arg_vector(11);
    ...
    params.COVIS_DELTA_C   = arg_vector(12);
    params.COVIS_DELTA_E   = arg_vector(13);
    params.COVIS_PERSEV    = arg_vector(14);
    params.COVIS_LAMBDA    = arg_vector(15);
