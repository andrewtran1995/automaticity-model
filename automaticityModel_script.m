% AUTOMATICITYMODEL_SCRIPT   Generate MEX-function automaticityModel_mex
%  from automaticityModel.
% 
% See also CODER, CODER.CONFIG, CODER.TYPEOF, CODEGEN.
% Generated by command: coder -tocode automaticityModel -script
% automaticityModel_script.m
