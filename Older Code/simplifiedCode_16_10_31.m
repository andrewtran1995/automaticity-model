...
W_MAX = 100;                % maximum possible weight for Hebbian Synapses
...
for j=1:TRIALS
    ...
    PMC_A.v_stim = full_matrix(r1,r2,1)*Visual.input_matrix;

    integral_visinputA   = trapz(PMC_A.v_stim);
    ...
    % Equation determining weights at Visual-PMC_A Synapses
    ...
    PMC_B.v_stim = full_matrix(r1,r2,2)*Visual.input_matrix;

    integral_visinputB   = trapz(PMC_B.v_stim);
